function Filter() {
  return (
    <div className='filter'>
      <div className='my-7'>
        <input className='mr-3' type='checkbox' name='Full Time' id='FT' />
        <label htmlFor='FT'>Full time</label>
      </div>

      <div className='location'>
        <h3>LOCATION</h3>
        <div className='searchLocation bg-white rounded-md h-12 p-2 my-5 flex items-center justify-between shadow-sm '>
          <svg
          ...
          <input
            className='truncate w-full h-8 ml-3  rounded-md outline-none'
            type='search'
            name=''
            id=''
      ...
      <div className='radio flex flex-col'>
        <label>
          <input className='mb-2 mr-3' type='radio' name='check' id='london' />
          London
        </label>
        ...
        <label>
          <input className='mb-2 mr-3' type='radio' name='check' id='Berlin ' />
          Berlin
        </label>
      </div>
    </div>
